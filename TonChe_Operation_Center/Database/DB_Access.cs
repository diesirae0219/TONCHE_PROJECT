...
namespace TonChe_Operation_Cneter
{
    ...
    {//114.33.130.81\SQLEXPRESS
        ...
        public DB_Access()
        {
            ...
            {
                Constr = @"Provider=SQLOLEDB;Data Source=.\\SQLEXPRESS; AttachDbFilename =D:\\Database\\TonChe.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True";//"Provider=SQLOLEDB;server=(local);Initial Catalog=TonChe;Integrated Security=true;";//"Provider=Microsoft.Ace.OLEDB.12.0;Data Sorce=";
            }
        }
        ...
        public static void OleDbInsertUpdateDelete(string Database, string OleDbSelectString)
        {
            ...
            {
                icn = OleDbOpenConn(Constr);
            }
            else
            {
                icn = OleDbOpenConn(ConstrLocal);
            }
        ...
        public DataTable QueryData(string sql)
        {
            ...
            {
                cnn = new SqlConnection(ConstrLocal);
            }
